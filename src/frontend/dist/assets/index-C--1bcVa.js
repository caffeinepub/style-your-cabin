...
function getImageKey(muscleGroup, exerciseName) {
...
function AvatarTrainer({
  ...
  const [frameIdx, setFrameIdx] = reactExports.useState(0);
  const [showCoach, setShowCoach] = reactExports.useState(false);
  const [coachText, setCoachText] = reactExports.useState("");
  const [motivationIdx, setMotivationIdx] = reactExports.useState(0);
  const prevKeyRef = reactExports.useRef("");
  const intervalRef = reactExports.useRef(null);
  const coachTimerRef = reactExports.useRef(null);
  const motivationIntervalRef = reactExports.useRef(
    null
  );
  const MOTIVATIONS = [
    "Keep going 💪",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-3 w-full", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        style: {
          background: "linear-gradient(180deg, #0B0F12 0%, #141B20 60%, #0A1015 100%)",
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              style: {
                background: "radial-gradient(ellipse at 70% 30%, rgba(255,122,26,0.06) 0%, transparent 65%),radial-gradient(ellipse at 20% 80%, rgba(37,99,235,0.05) 0%, transparent 55%)"
              }
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              style: {
                ...
                height: 1,
                background: "linear-gradient(90deg, transparent 0%, rgba(255,122,26,0.35) 30%, rgba(255,122,26,0.35) 70%, transparent 100%)"
              }
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                "img",
                {
                  ...
                  style: {
                    ...
                    maxWidth: "90%",
                    animation: frames.length > 1 ? "avatarPop 0.12s ease-out" : void 0,
                    imageRendering: "auto",
          ...
          showCoach && coachText && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#FF7A1A" }, children: "💬 " }),
                coachText
              ]
            }
          ),
          isResting && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              className: "absolute inset-0 flex flex-col items-center justify-center gap-2",
              style: { background: "rgba(11,15,18,0.68)" },
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-black text-3xl", style: { color: "#FF7A1A" }, children: "REST" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm", style: { color: "#9AA4AD" }, children: "Take a breath" })
              ]
            }
          ),
          !isResting && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-2 left-0 right-0 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
