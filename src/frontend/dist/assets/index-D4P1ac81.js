...
const IDLE_BOB_UP = { ...STAND, bY: -3 };
const IDLE_BOB_DOWN = { ...STAND, bY: 3 };
const ANIMS = {
  idle: [
    [IDLE_BOB_UP, 0],
    [IDLE_BOB_DOWN, 0.5],
...
const FLOOR_ANIM_KEYS = /* @__PURE__ */ new Set([
  "crunches",
  "leg_raises",
  "pushup",
  "bench_press",
...
function drawStickman(ctx, pose, cx, baseHipY, floorY) {
  const hx = cx;
...
function drawBackground(ctx, W, H, t, dots) {
...
function AvatarTrainer({
  ...
  stateRef.current.animKey = isResting ? "idle" : getAnimKey(muscleGroup, exerciseName);
  ...
  reactExports.useEffect(() => {
    ...
    const loop = (timestamp) => {
      ...
      let floorY;
      if (state.animKey === "pushup" || state.animKey === "bench_press" || state.animKey === "plank") {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[#141B20] border border-[#263038] rounded-2xl p-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-[#F2F4F6] font-bold text-xl mb-1", children: [
        "🏃 ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[#FF7A1A]", children: "Stickman Trainer" })
      ] }),
