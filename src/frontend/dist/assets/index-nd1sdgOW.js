...
const IDLE_UP = { ...STAND, bY: -2 };
const IDLE_DOWN = { ...STAND, bY: 2 };
const SQUAT_LOW = {
  bY: 28,
  head: { x: 14, y: -88 },
  neck: { x: 10, y: -74 },
...
const PLANK_BREATHE = { ...PLANK, bY: PLANK.bY + 2 };
const MC_FWD = {
  bY: 50,
  tiltDeg: 90,
  head: { x: 72, y: -6 },
...
const FLOOR_KEYS = /* @__PURE__ */ new Set([
  "crunches",
  "leg_raises",
  "pushup",
  "bench_press",
...
function getAnimKey(muscleGroup, exerciseName) {
...
function capsule(ctx, ax, ay, bx, by, r, fill) {
  const dx = bx - ax;
  const dy = by - ay;
...
function drawHumanSideProfile(ctx, pose, cx, baseHipY) {
  const hx = cx;
  const hy = baseHipY + pose.bY;
  const pt = (p) => ({ x: hx + p.x, y: hy + p.y });
...
function drawFloorMat(ctx, cx, matY) {
  const matW = 160;
  const matH = 12;
  ctx.save();
  ctx.beginPath();
...
function drawCoachBubble(ctx, text, cx, topY, alpha) {
  if (alpha <= 0) return;
  ctx.save();
...
function drawMotivation(ctx, text, cx, y, t) {
  ctx.save();
...
function AvatarTrainer({
  ...
  const stateRef = reactExports.useRef({
    ...
    coachText: "",
    coachTimer: 0,
    // seconds since exercise started
    motivationIdx: 0,
    motivationTimer: 0,
    prevAnimKey: ""
  });
  ...
  reactExports.useEffect(() => {
    ...
    const loop = (timestamp) => {
      ...
      const dt = state.lastTime ? Math.min((timestamp - state.lastTime) / 1e3, 0.05) : 0.016;
      ...
      if (!state.isResting) {
        ...
        if (state.motivationTimer >= 5) {
          ...
          state.motivationIdx = (state.motivationIdx + 1) % MOTIVATIONS2.length;
        }
      }
      ...
      if (state.coachText && state.coachTimer < 3.5) {
        ...
        const fadeOut = state.coachTimer > 3 ? 1 - (state.coachTimer - 3) / 0.5 : 1;
      ...
      if (!state.isResting) {
        drawMotivation(
          ctx,
          MOTIVATIONS2[state.motivationIdx],
          avatarCX,
          H - 14,
          state.t
        );
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-3 w-full", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[#FF7A1A] font-bold text-sm uppercase tracking-wider", children: isResting ? "Rest Period" : exerciseName }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[#9AA4AD] text-xs capitalize", children: [
...
function AvatarPage({ profile }) {
  ...
  const [motivationIdx, setMotivationIdx] = reactExports.useState(0);
  const timerRef = reactExports.useRef(null);
  const motivationRef = reactExports.useRef(null);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[#141B20] border border-[#263038] rounded-2xl p-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-[#F2F4F6] font-bold text-xl mb-1", children: [
        "🏋️ ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[#FF7A1A]", children: "AI Trainer" })
      ] }),
    ...
    currentExercise && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[#141B20] border border-[#263038] rounded-2xl p-4 md:col-span-1", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 pt-4 border-t border-[#263038]", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs font-semibold text-[#9AA4AD] uppercase tracking-wider mb-2", children: [
              "Speed:",
              " ",
              speed === 0.5 ? "Slow" : speed === 1 ? "Normal" : "Fast"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2", children: [0.5, 1, 1.8].map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
                "data-ocid": "avatar.toggle",
                onClick: () => setSpeed(s),
                className: `flex-1 py-1.5 rounded-lg text-xs font-medium transition-all ${speed === s ? "bg-[#FF7A1A] text-white" : "bg-[#1A2228] border border-[#263038] text-[#9AA4AD] hover:border-[#FF7A1A]/40"}`,
                children: s === 0.5 ? "🐢 Slow" : s === 1 ? "🚶 Normal" : "🔥 Fast"
              },
              s
            )) })
          ] })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-2 space-y-4", children: [
          ...
          isRunning && !isResting && /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              className: "rounded-2xl p-3 text-center border border-[#FF7A1A]/25 bg-[#141B20]",
              style: {
                background: "linear-gradient(135deg, rgba(20,27,32,1) 0%, rgba(30,20,10,0.7) 100%)"
              },
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  ...
                  children: MOTIVATIONS[motivationIdx]
                }
              )
            }
          ),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[#141B20] border border-[#263038] rounded-2xl p-5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-[#F2F4F6] font-bold text-base mb-1", children: "Before & After Progress" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[#9AA4AD] text-xs mb-4", children: "Body shape updates as you log daily weight and measurements" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-4 justify-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[#9AA4AD] text-xs font-semibold uppercase tracking-wider", children: "Before" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center gap-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-px flex-1 bg-gradient-to-b from-transparent via-[#263038] to-transparent" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
